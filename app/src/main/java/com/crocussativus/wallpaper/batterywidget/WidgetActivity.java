...
public class WidgetActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStatusView = findViewById(R.id.state);
        mPlugView = findViewById(R.id.plug);
        mLevelView = findViewById(R.id.level);
        mScaleView = findViewById(R.id.scale);
        mVoltageView = findViewById(R.id.voltage);
        mTemperatureView = findViewById(R.id.temperature);
        mTechnologyView = findViewById(R.id.technology);
    ...
    private String getVoltage(BatteryInfo batteryInfo) {
        return batteryInfo.getVoltage() + "mV";
    }
