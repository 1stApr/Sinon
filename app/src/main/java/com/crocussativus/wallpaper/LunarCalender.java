...
public class LunarCalender {
    ...
    public LunarCalender(int mLunarDay, int mLunarMonth, int mLunarYear) {
        int intNgay = mLunarDay;
        int intThang = mLunarMonth;
        int intNam = mLunarYear;
        ...
        this.mLunarDay = Ngay;
        this.mLunarMonth = Thang;
        this.mLunarYear = Nam;
    }

    public int getmLunarDay() {
        return mLunarDay;
    }

    public void setmLunarDay(int mLunarDay) {
        this.mLunarDay = mLunarDay;
    }

    public int getmLunarMonth() {
        return mLunarMonth;
    }

    public void setLunarMonth(int mLunarMonth) {
        this.mLunarMonth = mLunarMonth;
    }

    public int getmLunarYear() {
        return mLunarYear;
    }

    public void setmLunarYear(int mLunarYear) {
